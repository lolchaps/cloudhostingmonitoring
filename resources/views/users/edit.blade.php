                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('users.update', $user) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control" name="surname" value="{{ old('surname') ? old('surname') : $user->surname }}">
                        ...
                        <div class="form-group{{ $errors->has('mobile_no') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_no" type="text" class="form-control" name="mobile_no" value="{{ old('mobile_no') ? old('mobile_no') : $user->mobile }}">
                        ...
                        <div class="form-group{{ $errors->has('signature') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="signature" type="text" class="form-control" name="signature" value="{{ old('signature') ? old('signature') : $user->signature }}">
                        ...
                        <div class="form-group{{ $errors->has('mobile_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_id" type="text" class="form-control" name="mobile_id" value="{{ old('mobile_id') ? old('mobile_id') : $user->mobile_id }}">
                            ...
                            <div class="col-md-6">
                                <select name="permissions[]" id="permissions" class="form-control input-sm" multiple="multiple">
                                    @foreach ($permissions as $key => $permission)
                                        <option value="{{ $key }}" {{ $user->permissions->contains('id', $key) ? 'selected' : '' }}>
                                            {{ $permission }}
                                        </option>
                                    @endforeach
                                </select>
